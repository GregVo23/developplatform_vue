    ...
    public function run()
    {
        ...
        $subCategories = [
            ...
            ['name'=>'Peinture et dessin',
             ...
             'category_id' => 1,
             'description'=> 'Peintures en tout genre comme l\'aquarelle, la peinture à l\'huile et autres dessins réalisés au crayon ou pastel... ',
            ],  
            ['name'=>'Vidéo',
            ...
            ['name'=>'Application web',
             ...
             'category_id' => 2,
             'description'=> 'Toutes applications destinées à un usage sur le web.',
            ],  
            ['name'=>'Application mobile',
             'image'=> env('APP_URL').'/images/subcategories/s9.jpg',
             'category_id' => 2,
             'description'=> 'Toutes applications destinées à un usage sur mobile.',
            ],  
            ['name'=>'Site web',
            ...
            ['name'=>'Correction de code',
             ...
             'category_id' => 2,
             'description'=> 'Toutes corrections de code déjà implémentés et nécessitant diverses retouches.',
            ],  
            ['name'=>'Référencement web',
             'image'=> env('APP_URL').'/images/subcategories/s12.jpg',
             'category_id' => 2,
             'description'=> 'Conseil et aide en vue d\'un meilleur référencement sur les moteurs de recherches.',
            ], 
        ];
