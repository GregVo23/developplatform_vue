...
<body class="stretched">
    ...
    <div id="wrapper" class="clearfix">
                ...
                <div class="container mx-auto sm:px-4">
                    <div class="header-row px-4 sm:px-0">
                        ...
                        <div id="logo" class="py-2 sm:py-0">
                            <a href="{{ url('/') }}" class="standard-logo"><img src="./images/logo.svg"
                                    alt="Logo"></a>
                            <a href="{{ url('/') }}" class="retina-logo"><img src="./images/logo.svg"
                                    alt="Logo"></a>
                        </div><!-- #logo end -->
                        ...
                        <nav class="primary-menu">
                            ...
                            <ul class="menu-container">
                                <li class="menu-item"><a class="menu-link" href="{{ route('customer') }}">
                                        <div>Demandeur</div>
                                    </a></li>
                                <li class="menu-item"><a class="menu-link" href="{{ route('maker') }}">
                                        <div>Réalisateur</div>
                                    </a></li>
                                ...
                                <li class="menu-item">
                                    @auth
                                        <a href="{{ url('/dashboard') }}"
                                            class="button button-border rounded-full py-2 px-4">Mon compte</a>
                                    @else
                                        <a href="{{ route('login') }}"
                                            class="button button-border rounded-full py-2 px-4">Connexion</a>
                                    </li>
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}"
                                            class="button button-border rounded-full py-2 px-4">S'enregistrer</a>
                                    @endif
                                @endauth
                            </ul>
        ...
        <!-- Slider
        ============================================= -->
        <section id="slider" class="slider-element min-vh-md-100 sm:py-4 include-header"
            style="background: #e5e5e5 repeat top center; background-size: cover; z-index: 1;">
                ...
                <div class="vertical-middle slider-element-fade" style="background-color: #e5e5e5">
                    <div class="container mx-auto px-4 py-12 sm:py-5 text-center" style="background-color: white">
                        <div class="emphasis-title mb-2">
                            <h4 class="uppercase ls3 font-weight-bolder mb-0">Demandes de <strong>réalisations</strong>
                                à une communauté de</h4>
                            <h1>
        ...
        <section id="content">
            <div class="content-wrap p-0" style="background-color: #F4F4F4;">
                ...
                <div class="section mb-0 pt-3 pb-0 py-4 sm:py-0"
                    style="background-color: #F4F4F4; margin-top: 0px; overflow: visible;">
                    <div class="container mx-auto sm:px-4">
                    ...
                    <div class="flex justify-center relative">
                        <div class="parallax min-vh-75"
                            style="background-image: url('./images/designer-project.jpg'); background-size: cover; background-position: center center;"
                            data-bottom-top="width: 40vw" data-center-top="width: 100vw;">
                            <div class="flex flex-wrap  items-center justify-center h-full">
                                <div class="col-auto text-center">
                                    <a href="#"
                                        class="text-4xl font-weight-bolder text-white inline-block mx-4 h-op-08 op-ts"><u>Prestataire</u></a>
                                    <a href="#"
                                        class="text-4xl font-weight-bolder text-white inline-block mx-4 h-op-08 op-ts"><u>Client</u></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row flex-wrap col-mb-30 mt-5">
                        <div class="md:w-1/3 pr-4 pl-4">
                            <div class="flex items-center justify-center">
                                <div class="counter counter-xlarge text-white font-weight-bolder"><span data-from="1"
                                        data-to="{{ $withoutOffer }}" data-refresh-interval="2"
                ...
                <div class="footer-widgets-wrap  m-0">
                    ...
                    <div class="flex flex-wrap  justify-between">
                        ...
                        <div class="sm:w-1/2 pr-4 pl-4">
                            <div class="widget">
                                ...
                                <div class="flex">
                                    ...
                                    <a href="http://linkedin.com/" target="_blank">
                                        <img src="{{ asset('images/in.png') }}" alt="linkedin logo"
                                            class="object-cover h-14" />
                                    </a>
                            ...
                            <a href="mailto:info@developplatform"
                                class="h4 text-gray-900 mt-5 mb-4 block"><u>info@developplatform
                                    .com</u> <i class="icon-line-arrow-right relative ml-2" style="top: 3px"></i></a>
                            <a class="mt-8 text-sm hover:text-yellow"
                                href="{{ asset(env('APP_URL') . '/reglement/reglement.pdf') }}">Mentions légales &
                                réglement d'ordre intérieur</a>
                        </div>
                        <div id="plainte" class="sm:w-1/2 pr-4 pl-4">
                            <div id="contact">
                                    ...
                                    <div class="flex flex-wrap  mb-0">
                                        <div class="w-full mb-4">
                                            ...
                                            <input type="text" name="name"
                                                class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded border-form-control required"
                                                value="@auth{{ Auth()->user()->firstname ? Auth()->user()->firstname : '' }}  {{ Auth()->user()->lastname ? Auth()->user()->lastname : '' }}@endauth">
                                        </div>
                                        <div class="w-full mb-4">
                                            <label>Votre adresse email ?</label>
                                            <input type="email" name="email"
                                                class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded border-form-control required"
                                                value="@auth{{ Auth()->user()->email ? Auth()->user()->email : '' }}@endauth">
                                        </div>
                                        <div class="w-full mb-4">
                                            <label>Votre question ? Votre plainte ?</label>
                                            <textarea name="texte"
                                                class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-gray-100 text-gray-800 border border-gray-200 rounded"
                                                cols="10" rows="3"></textarea>
                                        </div>
                                        <div class="w-full">
                                            <button type="submit" name="landing-enquiry-submit"
                                                class="text-white h-translatey-3 bg-gray-900 rounded-full py-4 px-8 hover:bg-yellow">Envoyer</button>
                                        </div>
                                    </div>
                                </form>
    ...
    <div id="gotoTop" class="flex bg-white text-gray-900 rounded-full shadow">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mx-auto mt-1" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
