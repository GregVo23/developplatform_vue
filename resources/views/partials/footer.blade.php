<footer id="footer" class="bg-white z-50" aria-labelledby="footerHeading">
    ...
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
      <div class="space-y-8 xl:col-span-1">
        ...
        <div class="flex space-x-6">
          ...
          <a href="https://twitter.com/osselvan" class="text-gray-400 hover:text-gray-500">
          ...
          <a href="https://github.com/GregVo23/developplatform_vue.git" class="text-gray-400 hover:text-gray-500">
