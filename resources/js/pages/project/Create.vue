            ...
            <div>
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        ...
                        <u><b>ci-dessous</b></u> toutes les information liées à
                        ma demande de réalisation de projet.
                    </p>
                </div>
                <div
                ...
                >
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        <p class="mt-2 text-sm text-gray-500">
                            Expliquez ce que vous attendez comme résultat,
                            donnez des exemples.
                        </p>
                    </div>
                            ...
                            <div class="relative flex items-start">
                                ...
                                <div class="ml-3 text-sm">
                                    ...
                                    <p class="text-gray-500">
                                        Me notifier si je recois une offre de
                                        prix pour mon projet.
                                    </p>
                                </div>
                            </div>
                        </div>
