<template>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden sm:rounded-lg">
                <div class="p-6 border-b border-gray-200">
                    <h3 class="mx-2 text-xl text-gray-700">Bonjour <b> {{ user.firstname }} </b> !</h3><p class="mx-2 mt-2 text-gray-500">Prêt pour développer votre activité ?</p>
                    <div class="mt-4 flex">
                        <div class="flex mx-2">
                                    <router-link
                                        to="/rechercher"
    ...
    <div class="flex">
        <div class="flex-shrink sm-3/4 xl-w-2/4 -mb-50 -pb-50">
